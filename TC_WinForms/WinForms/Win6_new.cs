...
>>>>>>> 9f8dc77 (Добавлены миграции для создания таблицы затрат, внесения изменений в сущности staff_tc и machine_tc. Создан класс описания таблицы затрат. Добавлена форма таблицы затрат в WIin_6.Описан черновой вариант работы сервиса.)
